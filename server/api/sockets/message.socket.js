import {createMessage, getMessages, sendNewMessageAndCreateChat} from "../../services/message"
...
export default class MessageHandler {
    ...
    sendNewMessageAndCreateChat = (data, ackFn) => {
        wrapper(sendNewMessageAndCreateChat, data, this.socket.decoded_token.sub, ackFn)
    }
}
